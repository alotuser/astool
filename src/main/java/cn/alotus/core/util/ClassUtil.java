...
import cn.alotus.core.bean.NullWrapperBean;
import cn.alotus.core.convert.BasicType;
import cn.alotus.core.exceptions.UtilException;
import cn.alotus.core.io.FileUtil;
import cn.alotus.core.io.IORuntimeException;
import cn.alotus.core.io.resource.ResourceUtil;
import cn.alotus.core.lang.Assert;
import cn.alotus.core.lang.ClassScanner;
import cn.alotus.core.lang.Filter;
import cn.alotus.core.lang.Singleton;
...
public class ClassUtil {
	 ...
	 *
	 * <pre>
	 * isSimple为false: "com.alotuser.hutool.util.ClassUtil"
	 ...
	 *
	 * @param <T>                     对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，类名与方法名用{@code .}或{@code #}连接 例如：com.alotuser.hutool.StrUtil.isEmpty 或 com.alotuser.hutool.StrUtil#isEmpty
	 ...
	 *
	 * @param <T>                     对象类型
	 * @param classNameWithMethodName 类名和方法名表达式，例如：com.alotuser.hutool.StrUtil#isEmpty或com.alotuser.hutool.StrUtil.isEmpty
	 ...
	 * 获得给定类所在包的名称<br>
	 * 例如：<br>
	 * com.alotuser.hutool.util.ClassUtil =》 com.alotuser.hutool.util
	 *
	 * @param clazz 类
	 * @return 包名
	 */
